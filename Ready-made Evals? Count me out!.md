...
Use AI coding agents (Claude, Lovable, Cursor, any of them will work) to develop this. Don't worry about everything you might have to do with the tool in the future. *Focus only on **what you need Now***. Add features incrementally as you start needing them. The tool evolves as you do a few annotations and observe new needs.
### How to Annotate Effectively
Your ***error analysis and annotations set the tone for how you improve the product.*** When you sit down to annotate, wear the Product Manager (PM) hat. Ask questions like, (i) what experience your user should leave with, (ii) how the system should handle edge cases, (iii) whether a human should be looped in. Keep your requirements visible and watch out for unexpected LLM behaviour - is it aligned with your goals or pulling in a direction you didn't intend?
...
### Error Analysis and Annotation - In Action
...
This confirmed why the first round of annotation must be done manually. It **builds the intuition no LLM can give you**. This need for human analysis leads us to develop custom tools that will ease the process. 
#### Prompt
